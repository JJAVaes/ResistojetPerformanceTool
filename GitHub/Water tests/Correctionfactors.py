...
def correction_factor(massflow, pressure, temperature, power, isp, ambientpressure):
    ...
    temperature_propellant = 19 + 273.15            #C to K    
    Isp_real = isp                                  #s
    power_real = power                              #W
    ...
    speed_of_sound = CP.PropsSI('A', 'T', temperature_chamber, 'P', pressure_throat, propellant_name)
